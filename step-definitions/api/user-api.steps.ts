...
When('the user sends a GET request to {string}', async (endpoint: string) => {
  try {
...
When('the user sends a PUT request to update profile with name {string}', async (name: string) => {
  try {
