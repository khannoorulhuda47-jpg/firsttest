...
When('the user sends a GET request to search products with query {string}', async (query: string) => {
  try {
...
When('the user sends a PUT request to update product {int} with price {int}', async (productId: number, price: number) => {
  try {
...
When('the user sends a DELETE request to delete product {int}', async (productId: number) => {
  try {
